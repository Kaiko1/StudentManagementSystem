...
QT_MOC_LITERAL(4, 57, 28) // "on_cancel_pushButton_clicked"
    ...
    "InsertDialog\0refreshMainWindow\0\0"
...
void InsertDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (InsertDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InsertDialog::refreshMainWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InsertDialog::refreshMainWindow()
{
